        ...
        <>
            ...
            <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
                <div className="mx-auto mb-4 flex max-w-fit items-center justify-center space-x-2 overflow-hidden rounded-full border border-gray-200 bg-white px-7 py-2 shadow-md backdrop-blur transition-all hover:border-gray-300 hover:bg-white/50">
                    <p className="text-sm font-semibold text-gray-700 ">ChatDoc is in Beta</p>
                </div>
                <h1 className="max-w-4xl text-5xl font-bold md:text-6xl lg:text-7xl">
                    Chat with your <span className="text-blue-500">documents</span> in seconds.
                </h1>
                <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
                    ChatDoc allows you to have a convo with your documents. Simply upload your doc
                    and start chatting with the ai about it.
                </p>
                ...
                <div className="mb-12 px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl sm:text-center">
                        <h2 className="mt-2 font-bold text-4xl text-gray-900 sm:text-5xl">
                            Start chatting with your documents within minutes
                        </h2>
                        <p className="mt-4 text-lg text-gray-600">
                            Chatting with your documents has never been easier!
                        </p>
                    </div>
                </div>
                    ...
                    <div className="mt-16 flow-root sm:mt-24">
                        <div className="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                            {/* <Image
                                ...
                                height={700}
                                quality={100}
                                className="rounded-md bg-blue-50 p-2 sm:p-8 md:p-20 shadow-2xl ring-1 ring-gray-900/10"
                            /> */}
                        </div>
                    </div>
                </div>
